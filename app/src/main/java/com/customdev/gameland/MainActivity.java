...
//        game1.setLanguage("eclipse");
//        game1.setMaxPlayers(10l);
//        game1.setMinPlayers(6l);
//        game1.setDescribe("Eclipse description");
//        game1.setDuration(String.valueOf(4 * 60 * 60 * 1_000));
//
//        Game game2 = new Game();
//        game2.setId("2");
//        game2.setName("Game of Thrones");
//        game2.setLanguage("thrones");
//        game2.setMaxPlayers(8l);
//        game2.setMinPlayers(5l);
//        game2.setDescribe("Game of Thrones description");
//        game2.setDuration(String.valueOf(6 * 60 * 60 * 1_000));
//
//        Game game3 = new Game();
//        game3.setId("3");
//        game3.setName("Blood Rage");
//        game3.setLanguage("blood_rage");
//        game3.setMaxPlayers(6l);
//        game3.setMinPlayers(3l);
//        game3.setDescribe("Blood Rage description");
//        game3.setDuration(String.valueOf(4 * 60 * 60 * 1_000));
//
//        Game game4 = new Game();
//        game4.setId("4");
//        game4.setName("Agricola");
//        game4.setLanguage("agricola");
//        game4.setMaxPlayers(4l);
//        game4.setMinPlayers(4l);
//        game4.setDescribe("Agricola description");
//        game4.setDuration(String.valueOf(2 * 60 * 60 * 1_000));
//
//        list.add(game1);
//        list.add(game2);
//        list.add(game3);
